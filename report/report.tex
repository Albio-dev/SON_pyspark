...
\begin{document}
	...
	\item The map function takes a batch of the data and counts every occurrence of every itemset in the candidates list.\\
	The reducer adds up the counts from every batch and finally filters out the infrequent ones using the original support.
	\end{enumerate}
	The result of these phases is the list of \textit{frequent itemsets} (without false positives).
