...
\end{algorithm}
	...
	With the testing we have appreciated how SON execution time remains somewhat constant, while Apriori execution time grows exponentially with the number of items. Also, because of the way SON works, we expect it to work better on denser datasets and with a higher number of items, because splitting of the datasets produces
